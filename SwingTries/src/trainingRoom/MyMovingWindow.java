...
public class MyMovingWindow extends JFrame
        implements ComponentListener {

	private static final long serialVersionUID = -777862570233032315L;
	private JLabel labelx;
    private JLabel labely;

    public MyMovingWindow() {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                MyMovingWindow ex = new MyMovingWindow();
                ex.setVisible(true);
            }
        });
    }
