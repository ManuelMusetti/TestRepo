...
class MyShape extends Canvas implements MouseListener, MouseMotionListener {
	/**
	 * 
	 */
	...
	public void mousePressed(MouseEvent e) {
		...
		if (rect.contains(e.getX(), e.getY())) pressOut = true;
//			updateLocation(e);
//		else {
...
//		}
	...
	public void mouseDragged(MouseEvent e) {
		...
		else if (rect.contains(e.getX(), e.getY())) ShapeMover.label.setText("Drag it.");
	}
