...
public class MySwingEvents extends JFrame implements ActionListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = -1108593824702092805L;
	private JList list;
    private DefaultListModel model;

    public MySwingEvents() {
        initUI();
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                MySwingEvents ex = new MySwingEvents();
                ex.setVisible(true);
            }
        });
    }
