...
public class MyMultipleSourcesForListener extends JFrame {

    /**
	 * 
	 */
	private static final long serialVersionUID = -7750043055017638137L;
	JLabel statusbar;

    public MyMultipleSourcesForListener() {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                MyMultipleSourcesForListener ms = new MyMultipleSourcesForListener();
                ms.setVisible(true);
            }
        });
    }
